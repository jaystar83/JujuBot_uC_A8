 ...
 * Version: 0.0.1_0001
 *
 * Beispiel fuer die 2. Version eines Programms, in der 3. Nebenversion und in der 5. Fehlerkorrektur, Build 0041:
 * 2.3.5_0041
 * | | |  '------ Buildnummer
 * | | '--------- Revisionsnummer
 * | '----------- Nebenversionsnummer
...
//***	Timer	*****************************************************
	//(Mode,PreScaler, OCR) Mode: 0-Timer OFF, 1-TIMER �berlauf, 2-CTC
